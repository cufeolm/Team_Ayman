...
vsim -c -do "transcript file trans/run#.txt;vsim top +UVM_TESTNAME=bief_test +ARG_INST=BA ; log /* -r ; run -all ; quit"
vsim -c -do "transcript file trans/run#.txt;vsim top +UVM_TESTNAME=bief_test +ARG_INST=BCSF ; log /* -r ; run -all ; quit"
vsim -c -do "transcript file trans/run#.txt;vsim top +UVM_TESTNAME=bief_test +ARG_INST=BIEF ; log /* -r ; run -all ; quit"
vsim -c -do "transcript file trans/run#.txt;vsim top +UVM_TESTNAME=bief_test +ARG_INST=BVSF ; log /* -r ; run -all ; quit"
vsim -c -do "transcript file trans/run#.txt;vsim top +UVM_TESTNAME=bief_test +ARG_INST=BNEGF ; log /* -r ; run -all ; quit"